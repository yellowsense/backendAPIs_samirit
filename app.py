...
def confirm_nanny_booking():
    try:
        if request.method == 'POST':
            # For POST requests, insert into the database and send confirmation email
            ...
            # For GET requests, call the dynamic greeting function
...
def confirm_maid_booking():
    try:
        if request.method == 'POST':
            # For POST requests, insert into the database and send maid confirmation email
            ...
            # For GET requests, extract parameters from the URL and call the dynamic greeting function

            # Extract relevant details from the query parameters
...
def confirm_cook_booking():
    try:
        if request.method == 'POST':
            # For POST requests, insert into the database and send cook confirmation email
